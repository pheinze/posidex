...
<div class="result-group">
    ...
    <div class="result-item">
        ...
        <span id="positionSize" class="result-value text-lg text-success">{positionSize}</span>
    </div>
    <div class="result-item"><div class="result-label">{$_('dashboard.summaryResults.maxNetLossLabel')}<Tooltip text={$_('dashboard.summaryResults.maxNetLossTooltip')} /></div><span id="netLoss" class="result-value text-danger">{netLoss}</span></div>
    ...
    <div class="result-item"><span class="result-label">{$_('dashboard.summaryResults.breakEvenPriceLabel')}<Tooltip text={$_('dashboard.summaryResults.breakEvenPriceTooltip')} /></span><span id="breakEvenPrice" class="result-value text-warning">{breakEvenPrice}</span></div>
</div>
