...
<div>
    ...
    <div class="grid grid-cols-1 gap-4 mb-4">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <input type="text" inputmode="decimal" use:numberInput={{ decimalPlaces: 4 }} bind:value={fees} class="input-field w-full px-4 py-2 rounded-md" placeholder="{$_('dashboard.generalInputs.feesPlaceholder')}">
        </div>
    </div>
</div>