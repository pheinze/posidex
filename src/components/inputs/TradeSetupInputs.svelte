        ...
        {:else}
            ...
            {:else}
                <div class="grid grid-cols-3 gap-2 mt-2 items-end">
                    <div>
                        <label for="atr-timeframe" class="input-label !mb-1 text-[11px]">{$_('dashboard.tradeSetupInputs.atrTimeframeLabel')}</label>
                    ...
                    <div>
                        <div class="flex justify-between items-center">
                            <label for="atr-value-input-auto" class="input-label !mb-1 text-[11px]">{$_('dashboard.tradeSetupInputs.atrLabel')}</label>
                    ...
                    <div>
                        <label for="atr-multiplier-input-auto" class="input-label !mb-1 text-[11px]">{$_('dashboard.tradeSetupInputs.atrMultiplierLabel')}</label>
