...
<div>
    ...
    <div class="grid grid-cols-3 gap-4">
        <div>
            <label for="account-size" class="input-label text-base">{$_('dashboard.portfolioInputs.accountSizeLabel')}</label>
        ...
        <div>
            <label for="risk-percentage" class="input-label text-base">{$_('dashboard.portfolioInputs.riskPerTradeLabel')}</label>
        ...
        <div>
            <label for="risk-amount" class="input-label text-base">{$_('dashboard.portfolioInputs.riskAmountLabel')}</label>
            <div class="relative">
