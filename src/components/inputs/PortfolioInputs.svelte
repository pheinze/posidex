...
<div>
    ...
    <div class="grid grid-cols-2 gap-4">
        ...
        <div>
            ...
            <input id="risk-percentage" type="text" inputmode="decimal" use:numberInput={{ noDecimals: true, isPercentage: true, maxValue: 100 }} bind:value={riskPercentage} class="input-field w-full px-4 py-2 rounded-md" placeholder="{$_('dashboard.portfolioInputs.riskPerTradePlaceholder')}">
        </div>
    </div>
</div>